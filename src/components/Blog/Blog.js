    ...
    return (
        <div className='container'>
            <div className="ques my-4">
                <h3 className='text-white title p-4'>1. Difference between javascript and node js ?</h3>
            ...
            <div className="ques my-4">
                <h3 className='text-white title p-4'>2. When should you use node js and when should you use mongodb ?</h3>
                <div className="ans bg-info p-4">
            ...
            <div className="ques my-4">
                <h3 className='text-white title p-4'>3. Differences between sql and nosql databases ?</h3>
                <div className="ans bg-info p-4">
            ...
            <div className="ques my-4">
                <h3 className='text-white title p-4'>4. What is the purpose of jwt and how does it work ?</h3>
                <div className="ans bg-info p-4">
